<%@ Page Language="C#" MasterPageFile="~/Main.master"  AutoEventWireup="true" CodeFile="ZsContent.aspx.cs" Inherits="Content" Title="查看详细内容" %>
                                                        ...
                                                        <table border="0" cellpadding="5" cellspacing="0" style="width: 100%; height: 229px">
                                                            <tr>
                                                                <td align="right" style="border-right: #cccccc 1px dotted; width: 168px; border-bottom: #cccccc 1px dotted">
                                                                    发布时间：</td>
                                                                <td colspan="3" style="border-bottom: #cccccc 1px dotted">
