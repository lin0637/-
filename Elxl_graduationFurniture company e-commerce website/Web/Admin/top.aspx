...
<body bgColor='#ffffff'>
  ...
  <tr>
    <td width='20%' height="60"><div style="font-family:宋体; color:#FFFFFF; filter:Glow(Color=#000000,Strength=2); WIDTH: 100%; FONT-WEIGHT: bold; FONT-SIZE: 19pt; margin-top:5pt">
      <div align="center" class="STYLE5 STYLE1">家具企业电商网站</div>
    </div></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username"><%= Session["users"].ToString().Trim() %></span>，您的权限：<%= Session["role"].ToString().Trim() %>,欢迎使用 家具企业电商网站！
        	
        	[<a href="../Main.aspx" target="_top">退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
		...
		<dd><div class='itemsel' id='item1' onMouseMove="mv(this,'move',1);" onMouseOut="mv(this,'o',1);"><a href="UsersEdit.aspx" onclick="changeSel(1)" target="main">系统用户管理</a></div></dd>
