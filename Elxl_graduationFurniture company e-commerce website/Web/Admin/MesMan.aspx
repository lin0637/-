<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="MesMan.aspx.cs" Inherits="MyCar" Title="留言管理" %>
...
<body>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            <asp:BoundField DataField="fbbt" HeaderText="标题" />
        
            <asp:BoundField DataField="fbnr" HeaderText="内容" />
           
            <asp:BoundField DataField="fbr" HeaderText="发布人" />
            <asp:BoundField DataField="fbsj" HeaderText="发布时间" />
