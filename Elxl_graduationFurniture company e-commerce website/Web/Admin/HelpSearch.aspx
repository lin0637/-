<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="HelpSearch.aspx.cs" Inherits="Admin_GoodSearch" Title="维护" %>
        ...
        <tr>
            <td style="font-size: 14px; width: 100%; ">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    OnRowDataBound="GridView1_RowDataBound" OnRowEditing="GridView1_RowEditing" Width="100%" OnRowDeleting="GridView1_RowDeleting">
